  ...
  <form v-on:submit.prevent="submitForum" class="cardForm">
    ...
    <div>
      ...
      <input
        ...
        autocomplete="off"
        placeholder="Write your forum name here!"
        required
      />
    </div>
    ...
    <div>
      ...
      <textarea
        ...
        placeholder="Describe your forum's whole vibe!"
        required
      />
    </div>
    ...
    <div>
      ...
      <textarea
        ...
        class="form-control"
        v-model="forum.rules"
        placeholder="What are your forum's rules?"
        required
      />
    </div>
    ...
    submitForum() {
      ...
      forumsService
        ...
        .catch((error) => {
          if (error.response) {
            this.errorMsg =
              "Error submitting new forum. Response received was '" +
              error.response.statusText +
              "'.";
          } else if (error.request) {
            this.errorMsg =
              "Error submitting new forum. Server could not be reached.";
          } else {
            this.errorMsg =
              "Error submitting new forum. Request could not be created.";
          }
        });
    },
  },
